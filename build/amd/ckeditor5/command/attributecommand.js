define(['exports', './command.js', '../engine/model/treewalker.js', '../engine/model/range.js'], function (exports, _command, _treewalker, _range) {
	/**
  ...
  */
	class AttributeCommand extends _command2.default {
		/**
		...
		_checkEnabled() {
			...
			if (selection.isCollapsed) {
				...
				for (let range of ranges) {
					const walker = new _treewalker2.default({ boundaries: range, mergeCharacters: true });
