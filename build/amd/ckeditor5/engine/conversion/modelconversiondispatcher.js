define(['exports', './modelconsumable.js', '../model/range.js', '../model/textproxy.js', '../../utils/emittermixin.js', '../../utils/mix.js', '../../utils/lib/lodash/extend.js'], function (exports, _modelconsumable, _range, _textproxy, _emittermixin, _mix, _extend) {
	/**
  ...
  */
   ...
   */
		convertInsert(range) {
			...
			for (let value of range) {
				...
				const itemRange = _range2.default.createFromPositionAndShift(value.previousPosition, value.length);
				const data = {
					item: item,
					range: itemRange
				};
   ...
   */
		_createInsertConsumable(range) {
			const consumable = new _modelconsumable2.default();
   ...
   */
		_testAndFire(type, data, consumable) {
			...
			if (type === 'insert') {
				if (data.item instanceof _textproxy2.default) {
					// Example: insert:$text.
