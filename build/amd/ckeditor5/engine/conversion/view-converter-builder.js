define(['exports', '../view/matcher.js', '../model/element.js', '../../utils/isiterable.js'], function (exports, _matcher, _element, _isiterable) {
	/**
  ...
  */
	...
	exports.default = BuildViewConverterFor;
			...
			const eventCallbackGen = function (from) {
				return (evt, data, consumable, conversionApi) => {
					...
					for (let match of matchAll) {
						...
						const modelElement = element instanceof Function ? element(data.input) : new _element2.default(element);
  ...
  */
	function BuildViewConverterFor(...dispatchers) {
