define(['exports', '../../utils/lib/lodash/isArray.js', '../../utils/ckeditorerror.js', '../view/element.js', '../view/text.js', '../view/documentfragment.js'], function (exports, _isArray, _ckeditorerror, _element, _text, _documentfragment) {
	/**
  ...
  */
   ...
   */
		_add(type, item) {
			const items = (0, _isArray2.default)(item) ? item : [item];
  ...
  */
   ...
   */
		add(element, consumables) {
			...
			if (element instanceof _text2.default || element instanceof _documentfragment2.default) {
   ...
   */
		static createFrom(from, instance) {
			...
			if (from instanceof _text2.default) {
				instance.add(from);
			...
			if (from instanceof _element2.default) {
				instance.add(from, ViewConsumable.consumablesFromElement(from));
			}

			if (from instanceof _documentfragment2.default) {
				instance.add(from);
			}
