define(['exports', './viewconsumable.js', '../view/element.js', '../view/text.js', '../../utils/emittermixin.js', '../../utils/mix.js', '../../utils/lib/lodash/extend.js'], function (exports, _viewconsumable, _element, _text, _emittermixin, _mix, _extend) {
  /**
  ...
  class ViewConversionDispatcher {
    ...
    convert(viewItem, additionalData = {}) {
      ...
      const consumable = _viewconsumable2.default.createFrom(viewItem);
    ...
    _convertItem(input, consumable, additionalData = {}) {
      const data = (0, _extend2.default)({}, additionalData, {
        input: input,
        output: null
      });

      if (input instanceof _element2.default) {
        this.fire('element:' + input.name, data, consumable, this.conversionApi);
      } else if (input instanceof _text2.default) {
