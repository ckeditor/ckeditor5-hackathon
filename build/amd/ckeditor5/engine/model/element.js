define(['exports', './node.js', './nodelist.js', './documentfragment.js', './range.js', '../../utils/tomap.js'], function (exports, _node, _nodelist, _documentfragment, _range, _tomap) {
	/**
  ...
  */
   ...
   */
		getText() {
			...
			for (let value of _range2.default.createFromElement(this)) {
				if (value.type == 'TEXT') {
   ...
   */
		static fromJSON(json) {
			if (json.children) {
				return new Element(json.name, json.attributes, _nodelist2.default.fromJSON(json.children));
			}
