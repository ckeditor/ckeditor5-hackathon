define(['exports', './operation.js', '../../../utils/ckeditorerror.js'], function (exports, _operation, _ckeditorerror) {
	/**
  ...
  */
	class RootAttributeOperation extends _operation2.default {
		/**
   ...
   */
     ...
     * @param {*} value
     */
				throw new _ckeditorerror2.default('operation-rootattribute-no-attr-to-remove: The attribute which should be removed does not exists for given node.', { root: this.root, key: this.key });
			}
     ...
     * @param {String} key
     */
				throw new _ckeditorerror2.default('operation-rootattribute-attr-exists: The attribute with given key already exists.', { root: this.root, key: this.key });
			}
   ...
   */
     ...
     */
				throw new _ckeditorerror2.default('rootattributeoperation-fromjson-no-root: Cannot create RootAttributeOperation. Root with specified name does not exist.', { rootName: json });
			}
