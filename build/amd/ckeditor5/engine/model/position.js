define(['exports', './documentfragment.js', './element.js', '../../utils/lib/lodash/last.js', '../../utils/comparearrays.js', '../../utils/ckeditorerror.js'], function (exports, _documentfragment, _element, _last, _comparearrays, _ckeditorerror) {
	/**
  ...
  */
   ...
   */
		constructor(root, path) {
			if (!(root instanceof _element2.default) && !(root instanceof _documentfragment2.default)) {
				/**
     * Position root invalid.
     *
     * @error position-root-invalid.
     */
				throw new _ckeditorerror2.default('position-root-invalid: Position root invalid.');
			}
     ...
     * @param path
     */
				throw new _ckeditorerror2.default('position-path-incorrect: Position path must be an Array with at least one item.', { path: path });
			}
   ...
   */
		compareWith(otherPosition) {
			...
			const result = (0, _comparearrays2.default)(this.path, otherPosition.path);
   ...
   */
     ...
     */
				throw new _ckeditorerror2.default('position-after-root: You can not make position after root.', { root: node });
			}
   ...
   */
     ...
     * @param {engine.model.Node} root
     */
				throw new _ckeditorerror2.default('position-before-root: You can not make position before root.', { root: node });
			}
   ...
   */
		static createFromParentAndOffset(parent, offset) {
			if (!(parent instanceof _element2.default || parent instanceof _documentfragment2.default)) {
				/**
     * Position parent have to be a model element or model document fragment.
     *
     * @error position-parent-incorrect
     */
				throw new _ckeditorerror2.default('position-parent-incorrect: Position parent have to be a model element or model document fragment.');
			}
   ...
   */
     ...
     */
				throw new _ckeditorerror2.default('position-fromjson-no-root: Cannot create position for document. Root with specified name does not exist.', { rootName: json.root });
			}
