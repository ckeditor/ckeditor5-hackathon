define(['exports', './position.js', './element.js', '../../utils/lib/lodash/clone.js', '../../utils/lib/lodash/isArray.js', '../../utils/lib/lodash/isString.js', '../../utils/ckeditorerror.js'], function (exports, _position, _element, _clone, _isArray, _isString, _ckeditorerror) {
	/**
  ...
  */
   ...
   */
     ...
     */
				throw new _ckeditorerror2.default('schema-item-exists: Item with specified name already exists in schema.');
			}
     ...
     */
				throw new _ckeditorerror2.default('schema-no-item: Item with specified name does not exist in schema.');
			}
