define(['exports', './characterproxy.js', '../../utils/tomap.js'], function (exports, _characterproxy, _tomap) {
	/**
  ...
  */
   ...
   */
		getCharAt(index) {
			...
			return new _characterproxy2.default(this.first._nodeListText, this.first._index + index);
		}
   ...
   */
		setAttributesTo(attrs) {
			let attrsMap = (0, _tomap2.default)(attrs);
