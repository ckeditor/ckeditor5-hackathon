define(['exports', '../../utils/keyboard.js'], function (exports, _keyboard) {
  /**
   ...
   */
  const BR_FILLER = exports.BR_FILLER = domDocument => {
   ...
   */
  const NBSP_FILLER = exports.NBSP_FILLER = domDocument => domDocument.createTextNode('\u00A0');
   ...
   */
  const INLINE_FILLER_LENGTH = exports.INLINE_FILLER_LENGTH = 7;
   ...
   */
  let INLINE_FILLER = exports.INLINE_FILLER = '';
