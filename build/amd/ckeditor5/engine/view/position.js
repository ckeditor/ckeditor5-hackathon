define(['exports', './text.js', '../../utils/comparearrays.js', '../../utils/ckeditorerror.js'], function (exports, _text, _comparearrays, _ckeditorerror) {
	/**
  ...
  */
   ...
   */
		get nodeAfter() {
			if (this.parent instanceof _text2.default) {
				return null;
			}
   ...
   */
		compareWith(otherPosition) {
			...
			const result = (0, _comparearrays2.default)(path, otherPath);
