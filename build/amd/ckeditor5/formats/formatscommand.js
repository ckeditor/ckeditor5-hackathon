define(['exports', '../command/command.js', '../engine/model/rootelement.js'], function (exports, _command, _rootelement) {
	/**
  ...
  */
	...
	class FormatsCommand extends _command2.default {
   ...
   */
	...
	exports.default = FormatsCommand;
