define(['exports', '../utils/collection.js', './region.js', './template.js', '../utils/ckeditorerror.js', './domemittermixin.js', '../utils/mix.js', '../utils/lib/lodash/isPlainObject.js'], function (exports, _collection, _region, _template, _ckeditorerror, _domemittermixin, _mix, _isPlainObject) {
	/**
  ...
  */
   ...
   */
    ...
    */
			this.regions = new _collection2.default({
				idProperty: 'name'
			});
   ...
   */
		get element() {
			...
			this._template = new _template2.default(this.template);
   ...
   */
		register(...args) {
			...
			if (typeof args[0] === 'string') {
				regionName = args[0];
				region = this.regions.get(regionName) || new _region2.default(regionName);
			} else if (args[0] instanceof _region2.default) {
     ...
     */
				throw new _ckeditorerror2.default('ui-view-register-wrongtype');
			}
     ...
     */
				throw new _ckeditorerror2.default('ui-view-register-badselector');
			}
       ...
       */
						throw new _ckeditorerror2.default('ui-view-register-override');
					}
   ...
   */
		applyTemplateToElement(element, def) {
			...
			new _template2.default(def).apply(element);
		}
   ...
   */
    ...
    */
			return (node, domUpdater) => {
				...
				valueSchema.filter(schemaItem => schemaItem.model).forEach(schemaItem => {
   ...
   */
		_extendTemplateWithModelBinders(def) {
			...
			if (!binders && (0, _isPlainObject2.default)(def)) {
   ...
   */
	...
	(0, _mix2.default)(View, _domemittermixin2.default);
