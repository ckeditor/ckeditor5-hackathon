define(['exports', './emittermixin.js', './ckeditorerror.js', './lib/lodash/extend.js', './lib/lodash/isObject.js'], function (exports, _emittermixin, _ckeditorerror, _extend, _isObject) {
	/**
  ...
  */
   ...
   */
    ...
    */
     ...
     */
				throw new _ckeditorerror2.default('observable-bind-to-missing-attr: Observable has no such attribute(s).');
			}
		});
