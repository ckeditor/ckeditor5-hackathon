define(['exports', '/ckeditor5/editor/standardeditor.js', '/ckeditor5/engine/dataprocessor/htmldataprocessor.js'], function (exports, _standardeditor, _htmldataprocessor) {
	/**
  ...
  */
	class VirtualTestEditor extends _standardeditor2.default {
		constructor(config) {
			super(null, config);
   ...
   */
	...
	exports.default = VirtualTestEditor;
});