define('tests', ['/ckeditor5/engine/view/element.js', '/ckeditor5/engine/view/text.js', '/ckeditor5/engine/view/documentfragment.js', '/ckeditor5/engine/conversion/viewconsumable.js'], function (_element, _text, _documentfragment, _viewconsumable) {
	/**
  ...
  */
	...
	describe('ViewConsumable', () => {
		...
		beforeEach(() => {
			viewConsumable = new _viewconsumable2.default();
		...
		describe('test', () => {
			...
			it('should test text nodes', () => {
				const text1 = new _text2.default();
				const text2 = new _text2.default();
			...
			it('should test document fragments', () => {
				const fragment1 = new _documentfragment2.default();
				const fragment2 = new _documentfragment2.default();
		...
		describe('consumablesFromElement', () => {
			it('should create consumable object from element', () => {
				const consumables = _viewconsumable2.default.consumablesFromElement(el);
		...
		describe('createFrom', () => {
			it('should return new ViewConsumable instance', () => {
				const newConsumable = _viewconsumable2.default.createFrom(el);

				expect(newConsumable).to.be.instanceof(_viewconsumable2.default);
				expect(newConsumable.test(el, { name: true })).to.be.true;
			});

			it('should return new ViewConsumable instance from document fragment', () => {
				const fragment = new _documentfragment2.default();
				const newConsumable = _viewconsumable2.default.createFrom(fragment);
			...
			it('should add all child elements', () => {
				const text1 = new _text2.default('foo');
				const text2 = new _text2.default('bar');
				const child1 = new _element2.default('p', { 'title': 'baz' }, [text1]);
				const child2 = new _element2.default('p');
				const child3 = new _element2.default('p', { 'style': 'top:10px;', 'class': 'qux bar' }, [text2, child2]);
