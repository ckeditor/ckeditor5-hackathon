define('tests', ['/ckeditor5/ui/region.js', '/ckeditor5/ui/view.js'], function (_region, _view) {
	/**
  ...
  */
	...
	function createRegionInstance() {
		class A extends _view2.default {
			constructor() {
				super();
				this.template = { tag: 'a' };
			}
		...
		class B extends _view2.default {
			constructor() {
				super();
				this.template = { tag: 'b' };
			}
		...
		region = new _region2.default('foo');
	}
});
